...
complete -c exa -l color            -d "when to use terminal colours" -a 'always auto never'
complete -c exa -l colour           -d "when to use terminal colours" -a 'always auto never'
...
complete -c exa -s L -l "level" -a '(seq 0 256)' -d    "limit the depth of recursion"
complete -c exa -s r -l "reverse"                -d    "reverse the sort order"
complete -c exa -s s -l sort                     -d    "which field to sort by" -a "name Name size extension Extension modified changed accessed created inode type none"
...
complete -c exa -s I -l ignore-glob         -r   -d    "glob patterns (pipe-separated) of files to ignore" # -a "(/bin/ls -a)"
...
complete -c exa -s t -l time          -d "which timestamp field to list" -a "modified accessed created"
...
complete -c exa -l time-style         -d "how to format timestamps" -a "default iso long-iso full-iso"
